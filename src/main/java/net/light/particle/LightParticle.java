...
public class LightParticle extends LightModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public LightParticle(LightModElements instance) {
		super(instance, 1);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("light"));
	}
